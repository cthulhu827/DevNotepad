...
{
    class ActionLink_ToolStripSplitButton : ActionLink_Base<ToolStripSplitButton>, IActionLink
    {
        public ActionLink_ToolStripSplitButton(UIAction action, ToolStripSplitButton control) : base(action, control) { }
