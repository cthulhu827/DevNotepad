...
{
    public class ActionLink_NonFocusableButton : ActionLink_Base<NonFocusableButton>, IActionLink
    {
        public ActionLink_NonFocusableButton(UIAction action, NonFocusableButton control) : base(action, control) { }
