...
{
    public class ActionLink_ToolStripMenuItem : ActionLink_Base<ToolStripMenuItem>, IActionLink
    {
        public ActionLink_ToolStripMenuItem(UIAction action, ToolStripMenuItem control) : base(action, control) { }
